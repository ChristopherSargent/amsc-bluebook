...
variable "mlflow_host" {
  type        = string
  description = "Public DNS hostname for the MLflow ingress (e.g. mlflow.staging.your-domain.com)."
}

variable "openmetadata_host" {
  type        = string
  description = "Public DNS hostname for the OpenMetadata ingress (e.g. openmetadata.staging.your-domain.com)."
}
